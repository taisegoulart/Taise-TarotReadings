const cards = [{ //decarar assim
  ...
  },
  {
      "id": 9,
      "name": "The Hermit",
      "meaning": "Upright: contemplation, search for truth, inner guidance. | Reversed: loneliness, isolation, lost your",
      "image": "images/09.png"
  },
  {
      "id": 10,
  ...
  },
  {
      "id": 13,
      "name": "Death",
      "meaning": "Upright: end of cycle, beginnings, change, metamorphosis. | Reversed: fear of change, holding on,",
      "image": "images/13.png"
  },
  {
      "id": 14,
...
function drawCard( draw ) { 
  ...
  let cardPosition = Math.floor(Math.random()*2); //usar math.round?
  if ( cardPosition === 1) {
